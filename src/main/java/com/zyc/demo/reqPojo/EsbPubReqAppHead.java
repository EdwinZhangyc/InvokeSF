...
@XmlType(propOrder = { "TellerId", "BranchId", "TlrPswd", "TlrLvl", "TlrType", "ChkFlag", "AuthFlag", "AuthTlrId",
		"AuthTlrPswd", "AuthBrchId" })
public class EsbPubReqAppHead implements Serializable {
	/* ESB 请求公共报文 APP_HEAD */
	...
	@XmlElement(name = "AuthTlrPswd")
	private String AuthTlrPswd;// 授权柜员密码
	...
	public String getAuthTlrPswd() {
		return AuthTlrPswd;
	}

	public void setAuthTlrPswd(String authTlrPswd) {
	...
	public String toString() {
		return "EsbPubReqAppHead [TellerId=" + TellerId + ", BranchId=" + BranchId + ", TlrPswd=" + TlrPswd
				+ ", TlrLvl=" + TlrLvl + ", TlrType=" + TlrType + ", ChkFlag=" + ChkFlag + ", AuthFlag=" + AuthFlag
				+ ", AuthTlrId=" + AuthTlrId + ", AuthTlrPswd=" + AuthTlrPswd + ", AuthBrchId=" + AuthBrchId + "]";
	}
